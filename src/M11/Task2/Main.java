...
public class Main {
    ...
    static void rewriteFile(String line) throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter("D:\\text.txt"));
        bw.write(line);
        bw.close();
    }
    ...
    public static void main(String[] args) throws IOException {
        rewriteFile(replacer(createMap(),readLineForFile()));
    }
