...
public class Main {
    public static void main(String[] args) {
        ...
        User u5 = new User(5, "Oran", 4000, 5, "DataArt", 1000, new ChinaBank(4, "Croatia", EUR, 10, 1200, 1, 100000));
        System.out.println(u5);
        User u6 = new User(6, "John", 5000, 6, "Funtime", 1000, new ChinaBank(5, "Belarus", USD, 10, 1200, 1, 100000));
